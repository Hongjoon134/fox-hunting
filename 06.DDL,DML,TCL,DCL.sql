...
-- GRANT 권한 부여 명령어
-- GRANT 권한이름 TO 계정
-- CREATE SESSION : 접근 권한 부여
-- CREATE TABLE : 테이블 생성 권한 부여
-- TABLESPACE : 테이블의 공간 할당 권한 부여
-- UNLIMITED TABLESPACE : 테이블의 공간 크기 지정 권한 부여

-- ROLE : 권한 묶음
-- CONNECT : 접근 권한 묶음
-- RESOURSE : 테이블, 시퀀스 등 객체 생성 권한

-- REVOKE : 권한 회수
-- REVOKE : 권한명(ROLE) FROM 계정
